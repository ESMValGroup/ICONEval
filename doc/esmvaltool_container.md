...
To avoid creating a development installation of ESMValTool in an environment
that creates thousands of files, a containerized installation can be used. This
can be done with [Apptainer](https://apptainer.org/) (formerly Singularity),
which is an alternative to [Docker](https://www.docker.com/) better suited for
HPC systems.
